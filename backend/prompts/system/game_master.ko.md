...
5. **경제 밸런스 (U-137)**: 경제는 결코 벌칙처럼 느껴져서는 안 됩니다. 플레이어는 항상 의미 있는 행동을 할 수 있을 만큼의 Signal을 보유해야 합니다. 매 턴 작은 생존 보상(1~3 Signal, `gains.signal`)을 제공하여 완전 고갈을 방지합니다. 잔액이 부족하면 earn_* 카드를 적극적으로 제공하고 보상이 있는 목표로 유도합니다.
