...
- **`frontend/`**: 게임 HUD, 액션 덱, 인벤토리, 씬 캔버스 등 사용자 인터페이스 담당. Zustand로 월드 상태 관리. i18n 기반의 다국어 지원 및 구버전 데이터 마이그레이션(U-041) 포함. **U-049 레이아웃 전략에 따라 사이드바 전체 스크롤을 제한하고 패널 내부 스크롤을 권장함.**
