...
- 기본 CRT 톤(효과 포함)에서 대비와 식별성을 확인한다(특히 16px, 그리고 중요 정보 영역의 배경/대비 조건에서도).
...
- **계획서**: [U-028[Mvp]](U-028[Mvp].md) - UI 스케일/마이크로 텍스트 기준(가독성 기준선)
