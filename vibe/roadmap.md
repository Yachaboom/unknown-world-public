...
**진행 중(현재 포커스)**: [U-017[Mvp]](unit-plans/U-017[Mvp].md) / **최근 완료**: [U-016[Mvp]](unit-results/U-016[Mvp].md) (2026-01-24)
...
| MVP  | M3        | 세션/데모프로필 + 실모델 + 복구        | 2026-01-24 | 3/10   | 🚧   |
...
ID=[U-017[Mvp]](unit-plans/U-017[Mvp].md) | ⚡Structured Output TurnOutput 생성 + Pydantic 검증 | Depends=U-016,U-005 | 🚧
