...
**전체**: 58/80 (72.5%) | **MVP**: 58/66 (87.8%) | **MMP**: 0/14 (0%)

**예상 완료(가정)**: MVP D-3 | MMP D-7  
_가정: 1인 기준 / 1일 순개발 4h / 유닛 평균 45분 / 버퍼 30% 포함_

_진행률 산정: `vibe/unit-results/` 또는 `vibe/progress.md`에 존재하는 완료 유닛(U/RU/CP) 기준._

**진행 중(현재 포커스)**: [U-022[Mvp]](unit-plans/U-022[Mvp].md) / **최근 완료**: [U-021[Mvp]](unit-results/U-021[Mvp].md) (2026-01-31)
...
ID=[U-022[Mvp]](unit-plans/U-022[Mvp].md) | ⚡Scanner 슬롯 UI + 업로드→아이템화 반영 | Depends=U-011,U-022 | ⏸️
