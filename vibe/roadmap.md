...
**전체**: 16/59 (27%) | **MVP**: 16/46 (35%) | **MMP**: 0/13 (0%)
...
**진행 중**: [U-031[Mvp]](unit-plans/U-031[Mvp].md) / **최근 완료**: [U-029[Mvp]](unit-results/U-029[Mvp].md) (2026-01-11)
...
| MVP  | M2        | 핵심 UI(액션덱/핫스팟/DnD) + 가독성/에셋 | 2026-01-15 | 0/19   | ⏸️   |
...
### MVP
ID=[U-029[Mvp]](unit-plans/U-029[Mvp].md) | nanobanana mcp 에셋 패스(UI 아이콘/프레임/placeholder) | Depends=U-030,U-028,U-008 | ✅
ID=[U-031[Mvp]](unit-plans/U-031[Mvp].md) | nanobanana mcp 상태 Placeholder Pack(Scene/오프라인/에러/차단) | Depends=U-030,U-004 | 🚧
...
**현재 작업**: [U-029[Mvp]](unit-plans/U-029[Mvp].md) - nanobanana mcp 에셋 패스(UI 아이콘/프레임/placeholder)
