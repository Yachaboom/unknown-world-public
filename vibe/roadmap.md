...
**전체**: 11/49 (22%) | **MVP**: 11/36 (30%) | **MMP**: 0/13 (0%)

**예상 완료(가정)**: MVP D-11 | MMP D-27  
_가정: 1인 기준 / 1일 순개발 4h / 유닛 평균 45분 / 버퍼 30% 포함_

**진행 중**: [U-006[Mvp]](unit-plans/U-006[Mvp].md) / **최근 완료**: [U-005[Mvp]](unit-results/U-005[Mvp].md) (2026-01-04)
...
### MVP
ID=[U-006[Mvp]](unit-plans/U-006[Mvp].md) | ⚡TurnInput/TurnOutput 스키마(Zod) | Depends=U-002 | 🚧
