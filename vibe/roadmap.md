...
**전체**: 43/70 (61%) | **MVP**: 43/57 (75%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [CP-MVP-04](unit-plans/CP-MVP-04.md) / **최근 완료**: [RU-005-S3](vibe/unit-runbooks/RU-005-S3-runbook.md) (2026-01-25)
...
| MVP  | M3        | 세션/데모프로필 + 실모델 + 복구        | 2026-01-24 | 8/10   | 🚧   |
...
ID=[CP-MVP-04](unit-plans/CP-MVP-04.md) | **체크포인트: 실모델 Hard Gate(스키마/경제/복구)** | Depends=RU-005 | 🚧
