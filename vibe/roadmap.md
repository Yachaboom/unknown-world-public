...
**전체**: 90/126 (71.4%) | **MVP**: 90/108 (83.3%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-081[Mvp]](unit-plans/U-081[Mvp].md) UI 레이아웃 수정 / **최근 완료**: [U-070[Mvp]](unit-results/U-070[Mvp].md) (2026-02-05)
...
ID=[U-071[Mvp]](unit-plans/U-071[Mvp].md) | Scene 처리중 UI 로딩 인디케이터 강화 | Depends=U-066 | 🚧
