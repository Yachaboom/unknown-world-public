...
**전체**: 20/62 (32%) | **MVP**: 20/49 (40%) | **MMP**: 0/13 (0%)
...
**진행 중**: [U-038[Mvp]](unit-plans/U-038[Mvp].md) / **최근 완료**: [U-037[Mvp]](unit-results/U-037[Mvp].md) (2026-01-14)
...
ID=[U-039[Mvp]](unit-plans/U-039[Mvp].md) | i18n 언어 리소스 JSON 구조 도입(ko-KR/en-US, 확장 가능) | Depends=U-004 | ⏸️
...
**현재 작업**: [U-038[Mvp]](unit-plans/U-038[Mvp].md) - 핵심 UI 아이콘 12종 재생성(v2, 퀄리티/용량/사이즈/식별성)
