...
**전체**: 59/80 (73.75%) | **MVP**: 59/66 (89.4%) | **MMP**: 0/14 (0%)
...
**진행 중(현재 포커스)**: [CP-MVP-06](unit-plans/CP-MVP-06.md) / **최근 완료**: [U-022[Mvp]](unit-results/U-022[Mvp].md) (2026-01-31)
...
ID=[CP-MVP-06](unit-plans/CP-MVP-06.md) | **체크포인트: Scanner 업로드 게이트(안전/좌표/비용)** | Depends=U-022 | 🚧
