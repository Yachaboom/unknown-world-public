...
**전체**: 104/137 (75.9%) | **MVP**: 104/119 (87.4%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-095[Mvp]](unit-plans/U-095[Mvp].md) Scanner 아이템 생성 랜덤화 / **최근 완료**: [U-094[Mvp]](unit-results/U-094[Mvp].md) (2026-02-07)
...
### MVP
ID=[U-095[Mvp]](unit-plans/U-095[Mvp].md) | Scanner 아이템 생성 개수 랜덤화 (1~3개, 가중치) | Depends=U-022,U-094 | 🚧
