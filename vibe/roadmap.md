...
**전체**: 50/74 (67%) | **MVP**: 50/61 (82%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [U-045[Mvp]](unit-plans/U-045[Mvp].md) / **최근 완료**: [U-044[Mvp]](unit-results/U-044[Mvp].md) (2026-01-27)
...
ID=[U-045[Mvp]](unit-plans/U-045[Mvp].md) | Backend 시작 시 rembg/모델 사전 점검 + 다운로드(preflight) | Depends=U-035 | 🚧
