...
**전체**: 25/62 (40%) | **MVP**: 25/49 (51%) | **MMP**: 0/13 (0%)
...
**진행 중**: [U-012[Mvp]](unit-plans/U-012[Mvp].md) / **최근 완료**: [U-011[Mvp]](unit-results/U-011[Mvp].md) (2026-01-17)
...
### MVP
ID=[U-012[Mvp]](unit-plans/U-012[Mvp].md) | ⚡DnD 드롭(아이템→핫스팟) TurnInput 이벤트 | Depends=U-010,U-011,U-008 | 🚧
