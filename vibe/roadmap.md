...
**전체**: 94/130 (72.3%) | **MVP**: 94/112 (83.9%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-080[Mvp]](unit-plans/U-080[Mvp].md) API 키 인증 핫픽스 / **최근 완료**: [U-074[Mvp]](unit-results/U-074[Mvp].md) (2026-02-05)
