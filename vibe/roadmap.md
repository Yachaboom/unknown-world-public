...
**전체**: 120/136 (88.2%) | **MVP**: 120/131 (91.6%) | **MMP**: 0/5 (0%)
...
**최근 완료**: [U-123[Mvp]](vibe/unit-results/U-123[Mvp].md) (2026-02-08) / **취소**: U-084[Mvp] (기존 아트 스타일 유지 결정)
...
ID=[U-123[Mvp]](unit-plans/U-123[Mvp].md) | Agent Console 접기 제거 + 대기열 상단/배지 하단 재배치 | Depends=U-114 | ✅
