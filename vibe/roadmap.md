...
**전체**: 34/65 (52%) | **MVP**: 34/52 (65%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [U-016[Mvp]](unit-plans/U-016[Mvp].md) / **최근 완료**: [RU-004[Mvp]](unit-plans/RU-004[Mvp].md) (2026-01-24)
...
| MVP  | M3        | 세션/데모프로필 + 실모델 + 복구        | 2026-01-24 | 2/10   | 🚧   |
