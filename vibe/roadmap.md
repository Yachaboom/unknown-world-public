...
**전체**: 16/61 (26%) | **MVP**: 16/48 (33%) | **MMP**: 0/13 (0%)
...
### MVP
ID=[U-031[Mvp]](unit-plans/U-031[Mvp].md) | nanobanana mcp 상태 Placeholder Pack(Scene/오프라인/에러/차단) | Depends=U-030,U-004,U-034 | 🚧
ID=[U-032[Mvp]](unit-plans/U-032[Mvp].md) | nanobanana mcp UI Chrome Pack(패널/카드 프레임/코너) | Depends=U-030,U-004,U-034 | ⏸️
