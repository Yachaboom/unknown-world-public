...
**전체**: 19/61 (31%) | **MVP**: 19/48 (39%) | **MMP**: 0/13 (0%)
...
**진행 중**: [U-038[Mvp]](unit-plans/U-038[Mvp].md) / **최근 완료**: [U-033[Mvp]](unit-results/U-033[Mvp].md) (2026-01-12)
...
| MVP  | M2        | 핵심 UI(액션덱/핫스팟/DnD) + 가독성/에셋 | 2026-01-15 | 5/21   | 🚧   |
