...
**전체**: 3/49 (6%) | **MVP**: 3/36 (8%) | **MMP**: 0/13 (0%)

**예상 완료(가정)**: MVP D-12 | MMP D-28  
_가정: 1인 기준 / 1일 순개발 4h / 유닛 평균 45분 / 버퍼 30% 포함_

**진행 중**: [U-004[Mvp]](unit-plans/U-004[Mvp].md) / **최근 완료**: [U-003[Mvp]](unit-results/U-003[Mvp].md) (2026-01-04)
...
| 단계 | ID        | 이름                                   | 목표일     | 진행률 | 상태 |
| ---- | --------- | -------------------------------------- | ---------- | ------ | ---- |
| MVP  | M1        | 스캐폴딩 + Turn 계약 + SSE 스트리밍    | 2026-01-05 | 3/10   | 🚧   |
