...
**전체**: 2/49 (4%) | **MVP**: 2/36 (6%) | **MMP**: 0/13 (0%)

**예상 완료(가정)**: MVP D-12 | MMP D-28  
_가정: 1인 기준 / 1일 순개발 4h / 유닛 평균 45분 / 버퍼 30% 포함_

**진행 중**: [U-003[Mvp]](unit-plans/U-003[Mvp].md) / **최근 완료**: [U-002[Mvp]](unit-plans/U-002[Mvp].md) (2026-01-03)
...
ID=[U-003[Mvp]](unit-plans/U-003[Mvp].md) | ⚡백엔드 FastAPI 초기화 (/backend) | Depends=U-001 | 🚧
