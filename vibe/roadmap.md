...
**전체**: 35/62 (56%) | **MVP**: 35/49 (71%) | **MMP**: 0/13 (0%)
...
**진행 중**: [CP-MVP-02](unit-plans/CP-MVP-02.md) / **최근 완료**: [RU-003-Q5](refactors/RU-003-Q5.md) (2026-01-17)
...
### MVP
ID=[RU-003[Mvp]](unit-plans/RU-003[Mvp].md) | 리팩토링: UI 상태 슬라이스/경계 정리 | Depends=U-012 | 🚧
