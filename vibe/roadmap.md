...
**전체**: 22/62 (35%) | **MVP**: 22/49 (45%) | **MMP**: 0/13 (0%)

**예상 완료(가정)**: MVP D-5 | MMP D-9  
...
**진행 중**: [U-009[Mvp]](unit-plans/U-009[Mvp].md) / **최근 완료**: [U-039[Mvp]](unit-results/U-039[Mvp].md) (2026-01-15)
...
**현재 작업**: [U-009[Mvp]](unit-plans/U-009[Mvp].md) - ⚡Action Deck(카드+비용/대안)
...
**완료**: [U-039[Mvp]](unit-results/U-039[Mvp].md) - i18n 언어 리소스 JSON 구조 도입(ko-KR/en-US, 확장 가능)

**진행중**: [U-009[Mvp]](unit-plans/U-009[Mvp].md) - ⚡Action Deck(카드+비용/대안)
