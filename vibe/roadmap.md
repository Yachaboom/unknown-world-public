...
**전체**: 47/70 (67%) | **MVP**: 47/57 (82%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [U-035[Mvp]](unit-plans/U-035[Mvp].md) / **최근 완료**: [U-020[Mvp]](unit-results/U-020[Mvp].md) (2026-01-25)
...
ID=[U-035[Mvp]](unit-plans/U-035[Mvp].md) | 실시간 이미지 생성 시 rembg 배경 제거 통합 | Depends=U-019,U-020 | 🚧
