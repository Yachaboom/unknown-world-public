...
**전체**: 105/137 (76.6%) | **MVP**: 105/119 (88.2%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-096[Mvp]](unit-plans/U-096[Mvp].md) 아이템 사용 시 소비(삭제) 로직 / **최근 완료**: [U-095[Mvp]](unit-results/U-095[Mvp].md) (2026-02-07)
