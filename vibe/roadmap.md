...
**전체**: 21/62 (33%) | **MVP**: 21/49 (42%) | **MMP**: 0/13 (0%)

**예상 완료(가정)**: MVP D-6 | MMP D-10  
...
**진행 중**: [U-039[Mvp]](unit-plans/U-039[Mvp].md) / **최근 완료**: [U-038[Mvp]](unit-results/U-038[Mvp].md) (2026-01-14)
...
| MVP  | M2        | 핵심 UI(액션덱/핫스팟/DnD) + 가독성/에셋 | 2026-01-15 | 6/22   | 🚧   |
...
### MVP
ID=[U-039[Mvp]](unit-plans/U-039[Mvp].md) | i18n 언어 리소스 JSON 구조 도입(ko-KR/en-US, 확장 가능) | Depends=U-004 | 🚧
...
**현재 작업**: [U-039[Mvp]](unit-plans/U-039[Mvp].md) - i18n 언어 리소스 JSON 구조 도입(ko-KR/en-US, 확장 가능)
...
**완료**: [U-037[Mvp]](unit-results/U-037[Mvp].md) - CRT/가독성 레이어링(Readable 모드 제거, 중요 영역 보호)

**진행중**: [U-038[Mvp]](unit-plans/U-038[Mvp].md) - 핵심 UI 아이콘 12종 재생성(v2, 퀄리티/용량/사이즈/식별성)
