...
**전체**: 88/126 (69.8%) | **MVP**: 88/108 (81.5%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-081[Mvp]](unit-plans/U-081[Mvp].md) UI 레이아웃 수정 / **최근 완료**: [U-069[Mvp]](unit-results/U-069[Mvp].md) (2026-02-05)
...
ID=[U-069[Mvp]](unit-plans/U-069[Mvp].md) | 텍스트 생성 FAST 모델 + "정밀조사" 트리거 Pro 모델 전환 | Depends=U-080 | ✅
