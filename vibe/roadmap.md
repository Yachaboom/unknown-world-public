...
**전체**: 39/62 (63%) | **MVP**: 39/49 (80%) | **MMP**: 0/13 (0%)
...
**진행 중**: [U-014[Mvp]](unit-plans/U-014[Mvp].md) / **최근 완료**: [U-013[Mvp]](unit-results/U-013[Mvp].md) (2026-01-18)
...
### MVP
ID=[U-014[Mvp]](unit-plans/U-014[Mvp].md) | ⚡Economy HUD + Ledger(프론트) | Depends=U-009,U-008 | 🚧
