...
**전체**: 45/70 (64%) | **MVP**: 45/57 (79%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [U-019[Mvp]](unit-plans/U-019[Mvp].md) / **최근 완료**: [CP-MVP-04](unit-plans/CP-MVP-04.md) (2026-01-25)
...
ID=[U-019[Mvp]](unit-plans/U-019[Mvp].md) | ⚡이미지 생성 엔드포인트/잡(조건부) | Depends=U-016,U-017 | 🚧
