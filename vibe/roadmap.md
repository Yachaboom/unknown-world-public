...
**전체**: 46/70 (66%) | **MVP**: 46/57 (81%) | **MMP**: 0/13 (0%)
...
**진행 중(현재 포커스)**: [U-020[Mvp]](unit-plans/U-020[Mvp].md) / **최근 완료**: [U-019[Mvp]](unit-results/U-019[Mvp].md) (2026-01-25)
...
| MVP  | M3        | 세션/데모프로필 + 실모델 + 복구        | 2026-01-24 | 9/10   | 🚧   |
...
ID=[U-020[Mvp]](unit-plans/U-020[Mvp].md) | ⚡프론트 이미지 Lazy Render(placeholder/폴백) | Depends=U-010,U-019 | 🚧
