...
**전체**: 100/137 (73.0%) | **MVP**: 100/119 (84.0%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-080[Mvp]](unit-plans/U-080[Mvp].md) API 키 인증 핫픽스 / **최근 완료**: [U-090[Mvp]](unit-results/U-090[Mvp].md) (2026-02-07)
...
ID=[U-092[Mvp]](unit-plans/U-092[Mvp].md) | 기본 초기 아이템 아이콘 프리셋 이미지 (nanobanana-mcp 활용) | Depends=U-075,U-091 | ⏸️
ID=[U-093[Mvp]](unit-plans/U-093[Mvp].md) | ⚡ItemIconGenerator 아이콘 생성 타임아웃 수정 | Depends=U-075 | ⏸️
ID=[U-094[Mvp]](unit-plans/U-094[Mvp].md) | ImageUnderstanding 응답 파싱 예외 시 자동 재시도 | Depends=U-021 | ⏸️
ID=[U-095[Mvp]](unit-plans/U-095[Mvp].md) | Scanner 아이템 생성 개수 랜덤화 (1~3개, 가중치) | Depends=U-022,U-094 | ⏸️
ID=[U-096[Mvp]](unit-plans/U-096[Mvp].md) | 아이템 사용 시 소비(삭제) 로직 | Depends=U-012,U-011 | ⏸️
