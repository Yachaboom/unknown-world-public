...
**전체**: 101/137 (73.7%) | **MVP**: 101/119 (84.9%) | **MMP**: 0/18 (0%)
...
**진행 중(현재 포커스)**: [U-080[Mvp]](unit-plans/U-080[Mvp].md) API 키 인증 핫픽스 / **최근 완료**: [U-091[Mvp]](unit-results/U-091[Mvp].md) (2026-02-07)
...
### MVP
ID=[U-092[Mvp]](unit-plans/U-092[Mvp].md) | 기본 초기 아이템 아이콘 프리셋 이미지 (nanobanana-mcp 활용) | Depends=U-075,U-091 | 🚧
